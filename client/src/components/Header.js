...
const Header = () => {
  ...
  return (
    <div>
        <div style={{display:"flex", alignItems:"center", justifyContent:"space-between",backgroundColor:"#E6F3EB", width:"105%", position:"relative", right:"30px",padding:"0 20px 0 20px"}}>
            <div>
            ...
            <Button style={{backgroundColor:"#6B9080",borderColor:"#6B9080", height:"45px", padding:"8px",fontSize:"20px",marginRight:"8px"}} size="sm "  onClick={e=>navigate("/Filistin/village/create")}>
            Create Village
            </Button>
            </div>
